        ...
        <div className="w-full py-20 lg:py-40 bg-background" id="pricing">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                    {/* Startup */}
                    <Card className="w-full rounded-lg cursor-pointer transition-all hover:border-primary/50" onClick={() => togglePlan('startup')}>
                    ...
                    {/* Growth */}
                    <Card className="w-full rounded-lg shadow-xl border-primary/20 bg-primary/5 cursor-pointer relative overflow-hidden" onClick={() => togglePlan('growth')}>
                    ...
                    {/* Scale */}
                    <Card className="w-full rounded-lg cursor-pointer transition-all hover:border-primary/50" onClick={() => togglePlan('scale')}>
                        <CardHeader className="pb-4">
                            <div className="flex justify-between items-center">
                ...
                <div className="w-full">
                    <Card className="w-full rounded-lg cursor-pointer bg-neutral-900 text-white border-neutral-800 transition-all hover:border-neutral-700" onClick={() => togglePlan('enterprise')}>
                        <CardHeader className="pb-4">
