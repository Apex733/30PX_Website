...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React17.useRef(true);
  const isPointerInTransitRef = React17.useRef(false);
  const skipDelayTimerRef = React17.useRef(0);
  React17.useEffect(() => {
  ...
  return (0, import_jsx_runtime10.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React17.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React17.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React17.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const openTimerRef = React17.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React17.useRef(false);
  ...
  const stateAttribute = React17.useMemo(() => {
  ...
  const handleDelayedOpen = React17.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_jsx_runtime10.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime10.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React17.useCallback(() => {
...
var TooltipTrigger = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React17.useRef(false);
    const handlePointerUp = React17.useCallback(() => isPointerDownRef.current = false, []);
    React17.useEffect(() => {
...
var TooltipContentHoverable = React17.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React17.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React17.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React17.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React17.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React17.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React17.forwardRef(
  (props, forwardedRef) => {
