...
// import NumberFlow from "@number-flow/react" // Using our stub or if installed
                    ...
                    <>
                        ...
                        {paymentFrequency === "yearly" && (
                            <p className="mt-1 text-xs text-muted-foreground">
                                Billed <span className="line-through text-muted-foreground/70 select-none opacity-80">${(tier.price.monthly as number) * 12}</span> ${price * 12} yearly
                            </p>
                        )}
                    </>
                ) : (
