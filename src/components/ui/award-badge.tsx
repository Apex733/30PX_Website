...
type AwardBadgeType = "golden-kitty" | "product-of-the-day" | "product-of-the-month" | "product-of-the-week" | "fiverr-level-2";
...
// Added brand primary color (#1e3a8a) at index 3 for Fiverr
const backgroundColor = ["#f3e3ac", "#ddd", "#f1cfa6", "#1e3a8a"];
...
const title: Record<string, string> = {
    ...
    "fiverr-level-2": "Fiverr Level 2 Seller",
};

export const AwardBadge = ({ type, place, link, customTitle }: AwardBadgeProps) => {
        ...
        >
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-180px sm:w-260px h-auto">
                    ...
                    <rect width="260" height="54" rx="10"
                        fill={type === 'fiverr-level-2' ? backgroundColor[3] : (backgroundColor[(place || 2) - 1] || backgroundColor[1])}
                    />
                    <rect x="4" y="4" width="252" height="46" rx="8" fill="transparent" stroke="#fafafa" strokeWidth="1" />
                    <text fontFamily="Helvetica-Bold, Helvetica" fontSize="9" fontWeight="bold" fill={type === 'fiverr-level-2' ? '#fafafa' : '#666'} x="53" y="20">
                        {type === 'fiverr-level-2' ? 'FIVERR' : 'PRODUCT HUNT'}
                    </text>
                    <text fontFamily="Helvetica-Bold, Helvetica" fontSize="16" fontWeight="bold" fill={type === 'fiverr-level-2' ? '#fafafa' : '#666'} x="52" y="40">
                        {customTitle || title[type]}{place && type !== 'fiverr-level-2' && ` #${place}`}
                    </text>
                    <g transform="translate(8, 9)">
                        <path fill={type === 'fiverr-level-2' ? '#fafafa' : '#666'}
                    ...
                    <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)">
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(358, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(30, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(60, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(96, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(233, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(271, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="hsl(300, 70%, 85%)" filter="url(#blur1)" opacity="0.25" />
                        </g>
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="transparent" filter="url(#blur1)" opacity="0.3" />
                        </g>
                        <g style={{
                        ...
                        <g style={{
                            ...
                            <polygon points="0,0 260,54 260,0 0,54" fill="#fafafa" filter="url(#blur1)" opacity="0.3" />
                        </g>
                    </g>
                </svg>
            </div>
