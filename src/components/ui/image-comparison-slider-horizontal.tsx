    ...
    (
        ...
        return (
            ...
            >
                ...
                {/* Badge for Right Image */}
                <div className="absolute bottom-4 right-4 z-0 px-3 py-1 bg-black/60 backdrop-blur-md rounded-full text-white text-xs font-medium border border-white/10">
                    Made with 30PX
                </div>
